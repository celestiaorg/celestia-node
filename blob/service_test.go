...
// newMockHeaderServiceWithTip builds a MockHeaderService whose visible "tip" is controlled
// by the returned atomic.Uint64. GetByHeight rejects 0/future heights to mirror nodebuilder
// behavior; WaitForHeight blocks until the tip catches up. Used to exercise the resume-
// from-height path without spinning up a real header store.
