...
func newSquareCopy(s square, size int) *squareCopy {
	return &squareCopy{
		ods:   s,
		total: size * size,
	}
...
func (w *squareCopy) CopyAtLeast(writer io.Writer, limit int) (int, error) {
