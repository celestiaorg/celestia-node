...
// TODO: This has to be significantly refactored to findPrunableHeights, rather then Headers,
// so I wonder if we can avoid that entirely by simply passing callback to Syncer or Store
