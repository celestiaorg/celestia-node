...
type FraudMessageRequest struct {
	RequestedProofType []uint32 `protobuf:"varint,1,rep,packed,name=RequestedProofType,proto3" json:"RequestedProofType,omitempty"`
}
...
func (m *FraudMessageRequest) GetRequestedProofType() []uint32 {
	if m != nil {
...
func (m *ProofResponse) GetType() uint32 {
	if m != nil {
		return m.Type
	}
	return 0
...
var fileDescriptor_318cb87a8bb2d394 = []byte{
	...
	,
}
		...
		case 1:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.RequestedProofType) == 0 {
					m.RequestedProofType = make([]uint32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					for shift := uint(0); ; shift += 7 {
