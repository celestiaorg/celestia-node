...
func (m *EDSRequest) GetDatahash() []byte {
	if m != nil {
		return m.Datahash
	}
	return nil
...
var fileDescriptor_49d42aa96098056e = []byte{
	...
	0x2f, 0x2e, 0x2c, 0x4d, 0x2c, 0x4a, 0xd5, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x57, 0xd2, 0xe0, 0xe2,
	0x72, 0x75, 0x09, 0x0e, 0x4a, 0x2d, 0x2c, 0x4d, 0x2d, 0x2e, 0x11, 0x92, 0xe2, 0xe2, 0x00, 0x29,
	0xc9, 0x48, 0x2c, 0xce, 0x90, 0x60, 0x54, 0x60, 0xd4, 0xe0, 0x09, 0x82, 0xf3, 0x95, 0xf4, 0xb8,
	0xb8, 0xc1, 0x2a, 0x8b, 0x0b, 0xf2, 0xf3, 0x8a, 0x53, 0x85, 0xe4, 0xb9, 0xd8, 0x8a, 0x4b, 0x12,
	0x4b, 0x4a, 0x8b, 0xc1, 0x0a, 0xf9, 0x8c, 0xd8, 0xf5, 0x82, 0xc1, 0xdc, 0x20, 0xa8, 0xb0, 0x96,
	...
	0xe5, 0x18, 0x92, 0xd8, 0xc0, 0xce, 0x36, 0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xc2, 0x5b, 0xb5,
	0x22, 0xea, 0x00, 0x00, 0x00,
}
...
func (m *EDSRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Datahash) > 0 {
		...
		i = encodeVarintExtendedDataSquare(dAtA, i, uint64(len(m.Datahash)))
		i--
		dAtA[i] = 0xa
	}
