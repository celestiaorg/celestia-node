...
//
// This protocol is request/response protocol that sends a request for specific data that lives in a specific namespace ID and receives a response with the data.
// The streams are established using the protocol ID: "{networkID}/shrex/nd/0.0.1" where networkID is the network ID of the network. (e.g. "arabica")
//
...
//
// 2. Request data from a peer by calling [Client.RequestND] on the client and passing in the context, the data root, the namespace ID and the peer ID:
//
