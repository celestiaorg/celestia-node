...
import (
	fmt "fmt"
	pb1 "github.com/celestiaorg/celestia-node/share/proof/pb"
...
type RangeNamespaceData struct {
	StartRow int64                    `protobuf:"varint,1,opt,name=StartRow,proto3" json:"StartRow,omitempty"`
	EndRow   int64                    `protobuf:"varint,2,opt,name=EndRow,proto3" json:"EndRow,omitempty"`
	Shares   []*RowShares             `protobuf:"bytes,3,rep,name=shares,proto3" json:"shares,omitempty"`
	Proof    *pb1.IncompleteRowsProof `protobuf:"bytes,4,opt,name=proof,proto3" json:"proof,omitempty"`
}
...
func (m *RangeNamespaceData) GetStartRow() int64 {
	if m != nil {
		return m.StartRow
	}
	return 0
...
func (m *RangeNamespaceData) GetEndRow() int64 {
	if m != nil {
		return m.EndRow
	}
	return 0
...
func (m *RangeNamespaceData) GetProof() *pb1.IncompleteRowsProof {
	if m != nil {
		return m.Proof
	}
	return nil
...
var fileDescriptor_9431653f3c9f0bcb = []byte{
	...
	,
}
...
func (m *RangeNamespaceData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.EndRow != 0 {
		i = encodeVarintShwap(dAtA, i, uint64(m.EndRow))
		i--
		dAtA[i] = 0x10
	}
	if m.StartRow != 0 {
		i = encodeVarintShwap(dAtA, i, uint64(m.StartRow))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *RangeNamespaceData) Size() (n int) {
	...
	_ = l
	if m.StartRow != 0 {
		n += 1 + sovShwap(uint64(m.StartRow))
	}
	if m.EndRow != 0 {
		n += 1 + sovShwap(uint64(m.EndRow))
	}
	if len(m.Shares) > 0 {
		for _, e := range m.Shares {
			l = e.Size()
...
func (m *RangeNamespaceData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.Proof == nil {
				m.Proof = &pb1.IncompleteRowsProof{}
			}
			if err := m.Proof.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
