...
var EmptyAccessor = &Rsmt2D{ExtendedDataSquare: square.EmptyEDS()}
...
type Accessor interface {
	...
	DataHash(ctx context.Context) (square.DataHash, error)
	// AxisRoots returns square.AxisRoots (DataAvailabilityHeader) of the Accessor.
	AxisRoots(ctx context.Context) (*square.AxisRoots, error)
