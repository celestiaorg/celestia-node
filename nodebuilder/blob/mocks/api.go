...
func (m *MockModule) Submit(arg0 context.Context, arg1 []*blob.Blob, arg2 ...blob.Option) (uint64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockModuleMockRecorder) Submit(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
