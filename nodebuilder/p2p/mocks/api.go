...
func (m *MockModule) ConnectionInfo(arg0 context.Context, arg1 peer.ID) ([]p2p.ConnectionInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ConnectionInfo", arg0, arg1)
	ret0, _ := ret[0].([]p2p.ConnectionInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ConnectionInfo indicates an expected call of ConnectionInfo.
func (mr *MockModuleMockRecorder) ConnectionInfo(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ConnectionInfo", reflect.TypeOf((*MockModule)(nil).ConnectionInfo), arg0, arg1)
}
