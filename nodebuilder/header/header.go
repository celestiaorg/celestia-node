...
type Module interface {
	...
	Get(ctx context.Context, hash libhead.Hash) (*header.ExtendedHeader, error)
	...
	Subscribe(context.Context) (libhead.Subscription[*header.ExtendedHeader], error)
}
...
type API struct {
	Internal struct {
		...
		SyncHead    func(ctx context.Context) (*header.ExtendedHeader, error)     `perm:"read"`

		Subscribe func(context.Context) (libhead.Subscription[*header.ExtendedHeader], error) `perm:"public"`
	}
}

func (api *API) Get(ctx context.Context, hash libhead.Hash) (*header.ExtendedHeader, error) {
	return api.Internal.Get(ctx, hash)
}
...
func (api *API) SyncHead(ctx context.Context) (*header.ExtendedHeader, error) {
	return api.Internal.SyncHead(ctx)
}

func (api *API) Subscribe(ctx context.Context) (libhead.Subscription[*header.ExtendedHeader], error) {
