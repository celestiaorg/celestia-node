...
*/
func TestSyncFullsWithBridge_IPLD_Network_Stable_Latest(t *testing.T) {
	fullNodesCount := 16
...
*/
func TestSyncFullsWithBridge_IPLD_Network_Partitioned_Latest(t *testing.T) {
	fullNodesCount := 16
...
*/
func TestSyncFullsWithBridge_IPLD_Network_Stable_Historical(t *testing.T) {
	fullNodesCount := 16
	targetHeight := 15
	topHeight := 30
...
8. Check FNs are synced to height 30
*/
func TestSyncFullsWithBridge_IPLD_Network_Partitioned_Historical(t *testing.T) {
	fullNodesCount := 16
	targetHeight := 15
	topHeight := 30
