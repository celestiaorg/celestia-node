...
type Module interface {
	...
	SharesAvailable(context.Context, *share.Root, ...peer.ID) error
...
type API struct {
	Internal struct {
		SharesAvailable           func(context.Context, *share.Root, ...peer.ID) error `perm:"public"`
...
func (api *API) SharesAvailable(ctx context.Context, root *share.Root, peers ...peer.ID) error {
	return api.Internal.SharesAvailable(ctx, root, peers...)
}
