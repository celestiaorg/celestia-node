...
require (
	...
	github.com/ipfs/go-blockservice v0.5.2 // down 1 version, 0.5.2 is marked as deprecated and raises alerts
...
replace (
	...
	github.com/filecoin-project/dagstore => github.com/celestiaorg/dagstore v0.0.0-20230823095320-1d66549bbeb3
