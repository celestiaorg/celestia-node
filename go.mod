...
require (
	...
	github.com/celestiaorg/celestia-app/v9 v9.0.0-arabica.0.20260519184355-5abc6308cf56
...
replace github.com/consensys/gnark-crypto => github.com/consensys/gnark-crypto v0.20.1
