...
require (
	...
	github.com/celestiaorg/celestia-app v0.6.1-0.20220802211248-87653d6cb78e
...
replace (
	...
	github.com/tendermint/tendermint => github.com/celestiaorg/celestia-core v1.3.0-tm-v0.34.20.0.20220803183501-23853888617a
)
