...
replace (
	github.com/celestiaorg/utils => github.com/celestiaorg/utils v0.0.0-20221212222936-167db0d57129 // uses an unmerged PR, delete when celestiaorg/utils PR#5 is merged
