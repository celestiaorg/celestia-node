...
replace (
	//TODO: remove this after the PR is merged (https://github.com/celestiaorg/celestia-app/pull/3952)
	github.com/celestiaorg/celestia-app/v3 => github.com/mojtaba-esk/celestiaorg-celestia-app/v3 v3.0.0-20241011072457-f7d910497d73
