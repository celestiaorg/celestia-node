...
require (
	...
	github.com/celestiaorg/celestia-app/v3 v3.0.2-mocha
...
replace (
	...
	github.com/tendermint/tendermint => github.com/celestiaorg/celestia-core v1.44.0-tm-v0.34.35.0.20241127151511-4ca8293c2468
)
