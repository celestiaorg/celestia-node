...
replace github.com/ipfs/boxo => github.com/Wondertan/boxo v0.0.0-20241029230725-340262ccefd0

replace github.com/quic-go/quic-go => github.com/Wondertan/quic-go v0.0.0-20241029234609-938dd1118b7f
