...
replace (
	github.com/celestiaorg/celestia-app => github.com/faddat/celestia-app v1.6.1-0.20240222001605-69472d965497
	...
	github.com/tendermint/tendermint => github.com/faddat/celestia-core v1.29.0-tm-v0.34.29.0.20240222093945-cd36a4de3a4d
)
